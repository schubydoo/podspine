...
/// serves as AAC from the data dir. This is the serve side of the track-folder
/// work: those rows carry no `source_path`, so the audio handler must resolve
/// them under the data dir and never try to rebuild them.
#[tokio::test]
