...
pub fn scan_book_as(
    ...
    if !serve_in_place {
        // Reclaim any episode file left in a container this ingest won't overwrite
        // (a transcode target changed, or transcoding was turned on or off). The
        // serve-in-place branch below sweeps its whole book dir instead.
